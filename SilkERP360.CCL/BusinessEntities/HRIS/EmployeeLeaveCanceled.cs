...
{
    [SilkERP360.CCL.DatabaseMapping.DatabaseEntityMapping("EMPLOYEE_LEAVE_CANCELED", "")]
    public class EmployeeLeaveCanceled : SilkERP360.CCL.Validation.ValidationBase
    {
        public EmployeeLeaveCanceled()
        {
        }
        ...
        [SilkERP360.CCL.DatabaseMapping.DatabaseColumnMapping("CANCEL_EMPLOYEE_CODE", typeof(System.UInt64), false, false)]
        protected System.UInt64 m_uint64_CancelEmployeeCode;
        public System.UInt64 CancelEmployeeCode
        {
            get { return this.m_uint64_CancelEmployeeCode; }
            set { this.m_uint64_CancelEmployeeCode = value; }
        }
