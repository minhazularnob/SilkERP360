...
namespace SilkERP360.CCL.Misc
{
    public class Mailer
    {
        ...
        private const System.String MAIL_PASSWORD = "Asdf1234";

        private System.Net.Mail.MailMessage m_obj_MailMessage;
        private System.Net.Mail.SmtpClient m_obj_SmtpClient;
        private System.Net.Mail.MailAddress m_obj_FromMailAddress;//D:\LiveSilkERP360\SilkERP360\BiometricDataSync\ServiceLog.cs
        ...
        public Mailer(System.Collections.Generic.List<System.String> IP_objLst_MailToList, System.Collections.Generic.List<System.String> IP_objLst_MailCcList)
        {
            ...
            this.m_obj_SmtpClient = new SmtpClient(Mailer.SMTP_SERVER_IP, Mailer.PORT);
