...
namespace SilkERP360.CCL.ObjectPool
{
    /// <summary>
    /// Generic object pool
    /// </summary>
    ...
    public class ObjectPool<T> where T : SilkERP360.CCL.ObjectPool.PooledObject
    {
        ...
        private const int DefaultPoolMaximumSize = 30;
        ...
        private System.Collections.Concurrent.ConcurrentQueue<T> PooledObjects { get; set; }
        // Action to be passed to the pooled objects to allow them to return to the pool
        private System.Action<PooledObject, bool> ReturnToPoolAction;
