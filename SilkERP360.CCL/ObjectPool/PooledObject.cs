...
namespace SilkERP360.CCL.ObjectPool
{
    ...
    /// </summary>
    public abstract class PooledObject : System.IDisposable
    {
        ...
        {
            // Returning to pool
            System.Threading.ThreadPool.QueueUserWorkItem(new System.Threading.WaitCallback((o) => HandleReAddingToPool(false)));
        }
