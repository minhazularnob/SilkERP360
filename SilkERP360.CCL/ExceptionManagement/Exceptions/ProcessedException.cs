...
{
    public class ProcessedException : SilkERP360.CCL.ExceptionManagement.Base.BaseException
    {
        ...
        public ProcessedException(System.String IP_str_Message, SilkERP360.CCL.ExceptionManagement.ExceptionInfo IP_obj_ExceptionInfo)
            : base(IP_str_Message)
        {
            // Add Implementation (if required)
        ...
        public ProcessedException(System.String IP_str_Message, System.Exception IP_obj_InnerException)
