...
namespace SilkERP360.CCL.ExceptionManagement.ExceptionHandlers
{
    ...
    public class SilkERPOfflineDataProcessExceptionHandler : SilkERP360.CCL.ExceptionManagement.Base.ExceptionHandlerBase,
        Microsoft.Practices.EnterpriseLibrary.ExceptionHandling.IExceptionHandler
    {
        public SilkERPOfflineDataProcessExceptionHandler(System.Collections.Specialized.NameValueCollection attributes)
        {
        }
