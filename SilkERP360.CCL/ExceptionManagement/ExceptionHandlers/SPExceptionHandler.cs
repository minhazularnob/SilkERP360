...
namespace SilkERP360.CCL.ExceptionManagement.ExceptionHandlers
{
    ...
    public class SPExceptionHandler : SilkERP360.CCL.ExceptionManagement.Base.ExceptionHandlerBase,
        Microsoft.Practices.EnterpriseLibrary.ExceptionHandling.IExceptionHandler,
        System.Web.SessionState.IRequiresSessionState
    {
        public SPExceptionHandler(System.Collections.Specialized.NameValueCollection attributes)
        {
        }
