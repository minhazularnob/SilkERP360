            ...
            try
            {
               ...
               // System.String lcl_str_SqlQuery = System.String.Empty;
                ...
                while (lcl_obj_EmployeeInfoReader.Read())
                {
                    ...
                    //txt_Lve_EmpID.Text = ;
                    //txtEmpName.Text = lcl_obj_EmployeeInfoReader["EMPLOYEE_NAME"].ToString();
                   // txtDepartment.Text = lcl_obj_EmployeeInfoReader["DEPT_NAME"].ToString();
                    // txtDesignation.Text = lcl_obj_EmployeeInfoReader["degn_name"].ToString();
