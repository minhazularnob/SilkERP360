...
{
    public partial class IncrementAndPromotionList : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                while (lcl_obj_EmployeeInfoReader.Read())
                {
                    ...
                    lcl_obj_EmployeeId.Attributes["DesignationCode"] = lcl_obj_EmployeeInfoReader["DESIGNATION_CODE"].ToString();
                    this.ddlEmployeePromotion.Items.Insert(lcl_ui32_Index++, lcl_obj_EmployeeId);
                }
                ...
                if ((lcl_obj_DesignationReader.HasRows))
                {
                    ...
                    while (lcl_obj_DesignationReader.Read())
                    {
                        ...
                        this.ddlNewDesignation.Items.Insert(lcl_i32_j++, lcl_obj_DesignationItem);
                    }
