...
<%--<script src="../../Globals/Scripts/plug-ins/jquery.formatCurrency-1.4.0/jquery.formatCurrency-1.4.0.min.js" type="text/javascript"></script>--%>
<%--<script src="../../Globals/Scripts/plug-ins/jquery.formatCurrency-1.4.0/i18n/jquery.formatCurrency.all.js" type="text/javascript"></script>--%>
            ...
            <td colspan="3"  style="width:100%; height:auto;">
                <div id="dvQCHead" style="width:100%; height:100%; border-bottom:2px ridge black;">
                    ...
                    <table style="width:90%; margin:0 auto;" class="ip_control_container" >
                        ...
                        <tr>
                            <td style="width:15%; text-align:left;">
                                <label>Salary Cycle From :</label>
                            </td>
                            <td style="width:34%; text-align:center;">
                                <asp:TextBox ID="txtSalaryCycleFrom" runat="server" style="text-align:center;" CssClass="" Width="100%" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                            </td>
                            <td style="width:2%;">
                                    &nbsp;
                            </td>
                            <td style="width:15%; text-align:left;">
                                <label>Salary Cycle Upto :</label>
                            </td>
                            <td style="width:34%;text-align:left; border: 0px solid black; vertical-align:middle;">
                                 <asp:TextBox ID="txtSalaryCycleUpto" runat="server" style="text-align:center;" CssClass="" Width="100%" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                       ...
                       <%-- <tr>
                            ...
                            <td style="width:34%; text-align:center;">
                                <asp:TextBox ID="TextBox1" runat="server" style="text-align:center;" CssClass="" Width="100%" ReadOnly="false" ClientIDMode="Static"></asp:TextBox>
                            </td>
                            <td style="width:2%;">
                                    &nbsp;
                            </td>
                            ...
                            <td style="width:34%;text-align:left; border: 0px solid black; vertical-align:middle;">
                                 <asp:TextBox ID="TextBox2" runat="server" style="text-align:center;" CssClass="" Width="100%" ReadOnly="false" ClientIDMode="Static"></asp:TextBox>
                        ...
                        <tr>
                            <td colspan="5" style="width:100%; text-align:center;">
                                <div>
                                    <a id="lnkSalaryGenerationSetup" href="#" class="command_button_enabled" onclick="SalaryGenerationSetup(event); return false;" style="width:180px;">
                                        Salary Generation Setup
                                    </a>
                                    <a id="lnkGenerateSalary" href="#" class="command_button_enabled" onclick="GenerateSalary(event); return false;" style="width:180px;">
                                        Generate Salary
                                    </a>
                                    <a id="lnkSaveSalary" href="#" class="command_button_enabled" onclick="SaveSalary(event); return false;" style="width:180px;">
                                        Save Salary
                                    </a>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td colspan="5">
                                <div id="dvDepartmentwiseWaiver" style="width:100%;">
                                    <table id="tblDepartmentwiseWaiver">
                                    </table>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="5">
                                <div id="dvEmployeewiseWaiver" style="width:100%; height:400px; overflow:scroll;">
        ...
        <tr>
            ...
            <td colspan="3" style="width:100%; height:auto;">
                <div id="dvGeneratedSalary" class="qc_test_form_container" style="width:100%; height:auto; border:0px ridge black;">
                    <h1>H.R.I.S Salary Generation</h1>
                    <table id="tblSalaryMaster" class="ip_control_container" style="width:70%; margin:0 auto;">
                        ...
                        <tr>
                            ...
                            <td style="width:20%; text-align:center;">
                                <asp:TextBox ID="txtTGross" runat="server" style="text-align:right;" CssClass="currency_field" Width="100%" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                            </td>
                            <td style="width:2%;">
                                    &nbsp;
                            </td>
                            ...
                            <td style="width:20%;text-align:left; border: 0px solid black; vertical-align:middle;">
                                 <asp:TextBox ID="txtTProvidentFund" runat="server" style="text-align:right;" CssClass="currency_field" Width="100%" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align:left; border: 0px solid black; vertical-align:middle;">
                                 <asp:TextBox ID="txtTTax" runat="server" style="text-align:right;" CssClass="currency_field" Width="100%" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align:left;">
                            ...
                            <td style="text-align:center;">
                                <asp:TextBox ID="txtTOvertimeAmount" runat="server" style="text-align:right;" CssClass="currency_field" Width="100%" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                            </td>
                            <td style="">
                                    &nbsp;
                            </td>
                            ...
                            <td style="text-align:left; border: 0px solid black; vertical-align:middle;">
                                 <asp:TextBox ID="txtTAbsent" runat="server" style="text-align:right;" CssClass="currency_field" Width="100%" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align:left;">
                            ...
                            <td style="text-align:center;">
                                <asp:TextBox ID="txtTAllowance" runat="server" style="text-align:right;" CssClass="currency_field" Width="100%" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                            </td>
                            <td style="">
                                    &nbsp;
                            </td>
                            ...
                            <td style="text-align:left; border: 0px solid black; vertical-align:middle;">
                                 <asp:TextBox ID="txtTLate" runat="server" style="text-align:right;" CssClass="currency_field" Width="100%" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align:left;">
                            ...
                            <td style="text-align:center;">
                                <asp:TextBox ID="txtTAdditionOthers" runat="server" style="text-align:right;" CssClass="currency_field" Width="100%" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                            </td>
                            <td style="">
                                    &nbsp;
                            </td>
                            ...
                            <td style="text-align:left; border: 0px solid black; vertical-align:middle;">
                                 <asp:TextBox ID="txtTAdvance" runat="server" style="text-align:right;" CssClass="currency_field" Width="100%" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align:left;">
                            ...
                            <td style="text-align:left; border: 0px solid black; vertical-align:middle;">
                                 <asp:TextBox ID="txtTDeductionOthers" runat="server" style="text-align:right;" CssClass="currency_field" Width="100%" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align:left;">
                            ...
                            <td style="text-align:left; border: 0px solid black; vertical-align:middle;">
                                 <asp:TextBox ID="txtTPayable" runat="server" style="text-align:right;" CssClass="currency_field" Width="100%" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
