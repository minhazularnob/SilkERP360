...
<div id="dCompany" class="container-fluid" style="font-family: serif">
    ...
    <!-- Row 6: Company List Table -->
    <div class="row mb-3">
        <div class="col-md-12">
            <div id="dvRoosterEmployees" style="width:100%; border:0;">
                <div id="dvSelectedEmployees" style="width:100%;">
