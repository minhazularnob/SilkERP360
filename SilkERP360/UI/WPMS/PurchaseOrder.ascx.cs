...
namespace SilkERP360.UI.WPMS
{
    public partial class PurchaseOrder : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ShowPOQuotationCode(lcl_obj_SqlFacade);
        ...
        void ShowPOQuotationCode(SilkERP360.FL.SqlFacade IP_obj_SqlFacade)
        {
            ...
            while (lcl_obj_Reader.Read())
            {
                ...
                lcl_obj_EmployeeItem.Value = lcl_obj_Reader["QUOTATION_M_CODE"].ToString();
                lcl_obj_EmployeeItem.Text = lcl_obj_Reader["QUOTATION_M_CODE"].ToString();
                this.ddlQuotation.Items.Insert(lcl_i32_K++, lcl_obj_EmployeeItem);
            }
        ...
        void BuyerCode(SilkERP360.FL.SqlFacade IP_obj_SqlFacade)
        {
            ...
            System.Data.OracleClient.OracleDataReader lcl_obj_Reader = IP_obj_SqlFacade.ExecuteDataReader(lcl_str_SqlQuery1);
        ...
        private void HDPEPriceLoad(SilkERP360.FL.SqlFacade IP_obj_SqlFacade)
        {
            ...
            System.Data.OracleClient.OracleDataReader lcl_obj_Reader = IP_obj_SqlFacade.ExecuteDataReader(lcl_str_SqlQueryHDPE);
