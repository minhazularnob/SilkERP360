...
$(document).ready(function () {
    ...
    $('#tblBendingTest').appendGrid({
        ...
        columns: [
                ...
                { name: 'FrontLong', display: 'Front Long', type: 'text', displayCss: { 'text-align': 'center' }, ctrlCss: { 'text-align': 'center'} },
                { name: 'FrontShort', display: 'Front Short', type: 'text', displayCss: { 'text-align': 'center' }, ctrlCss: { 'text-align': 'center'} },
                { name: 'BackLong', display: 'Back Long', type: 'text', displayCss: { 'text-align': 'center' }, ctrlCss: { 'text-align': 'center'} },
                { name: 'BackShort', display: 'Back Short', type: 'text', displayCss: { 'text-align': 'center' }, ctrlCss: { 'text-align': 'center'} },
                { name: 'ATRStatus', display: 'ATR Status', type: 'checkbox', displayCss: { 'text-align': 'center' }, ctrlCss: { 'text-align': 'center'} },
