<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="scpm_hm.aspx.cs" Inherits="SilkERP360.UI.SCPM.scpm_hm" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>SilkERP360-SilkCard Production Manager v.1.0-SCPM</title>
...
<%--    <script src="../../Globals/Scripts/plug-ins/confirm-box/js/script.js" type="text/javascript"></script>--%>
    ...
    <%--<script src="../../Globals/Scripts/plug-ins/auto-logout/auto-logout.js" type="text/javascript"></script>--%>
    <script src="../../Globals/Scripts/SilkERP360/SCPM/SCPMMenuFunctions.js" type="text/javascript"></script>
   <script src="../../Globals/Scripts/SilkERP360/SCPM/scpm_hm.js" type="text/javascript"></script>
