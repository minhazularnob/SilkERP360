<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QCCDDLTest.ascx.cs" Inherits="SilkERP360.UI.SCPM.QCCDDLTest" %>
<script src="Scripts/QCCDDLTest.js" type="text/javascript"></script>
...
<div id="dvQCMaster" style="width:100%; border:0px ridge black; margin:0 auto;">
    <table id="tblBody" cellpadding="5px" cellspacing="5px" style="width:100%;">
        <tr>
            <td>
                <div>
                    <h2>Cavity Dimension Depth & Location Test</h2>
                </div>
            </td>
        </tr>
        <tr>
