<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Overtime.ascx.cs" Inherits="SilkERP360.UI.HRIS.Overtime" %>
...
<script src="Scripts/Overtime.js" type="text/javascript"></script>
                ...
                <div id="dvQCHead" style="width:100%; height:100%; border-bottom:2px ridge black;">
                    ...
                    <table style="width:90%; margin:0 auto;" class="ip_control_container" >
                        ...
                        <tr>
                            ...
                            <td style="width:34%; text-align:center;">
                                <asp:TextBox ID="txtOTDateFrom" runat="server" style=" text-align:center;"  ClientIDMode="Static" CssClass="" Width="100%" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td style="width:2%;">
                                    &nbsp;
                            </td>
                        ...
                        <tr>
                            <td colspan="5" style="width:100%; text-align:center;">
                                <div>
                                    ...
                                    <asp:Button ID="btnOTSetup" runat="server" Width="100px" Text="O.T Setup" OnClientClick="SetupOT(event);return false;" ClientIDMode="Static" />&nbsp;
