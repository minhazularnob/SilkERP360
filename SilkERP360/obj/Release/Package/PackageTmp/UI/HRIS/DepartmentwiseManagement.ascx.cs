...
{
    /// <summary>
    /// /Event ID For Exceptions : 201
    /// </summary>
    public partial class DepartmentwiseManagement : SilkERP360.UI.Base.SilkWebUserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.ExceptionManager.Process(() =>
            {
                ...
                //System.Web.Script.Serialization.JavaScriptSerializer lcl_obj_JSSerializer = new System.Web.Script.Serialization.JavaScriptSerializer();
                //System.String lcl_str_DepartmentStrengthJSON = lcl_obj_JSSerializer.Serialize(lcl_obj_DepartmentStrengths);

                //ScriptManager.RegisterStartupScript(this, this.GetType(), "DEPARTMENT_STRENGTH", "var lcl_obj_DepartmentStrengths = " + lcl_str_DepartmentStrengthJSON + ";", true);
