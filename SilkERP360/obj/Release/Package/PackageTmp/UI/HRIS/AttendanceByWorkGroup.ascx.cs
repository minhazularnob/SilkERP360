...
{
    public partial class AttendanceByWorkGroup : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Oracle.ManagedDataAccess.Client.OracleDataReader lcl_obj_WorkGroupReader = lcl_obj_SqlFacade.ExecuteDataReader(lcl_str_SqlQuery);
