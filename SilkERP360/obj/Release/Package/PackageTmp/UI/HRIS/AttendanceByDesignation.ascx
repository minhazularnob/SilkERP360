            ...
            <div class="container-fluid my-4" id="dvWorkGroupMaster">
                <div class="card shadow-sm">
                    ...
                    <div class="card-header text-center bg-white">
                        <h2 class="fontSerif mb-0">Attendance By Designation</h2>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div id="dvQCHead" class="border-bottom pb-3 mb-4">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col-md-3">
                                    <asp:DropDownList ID="ddlDesignation" runat="server" Width="100%" ClientIDMode="Static" CssClass="form-select">
                                ...
                                <div class="col-md-2 text-md-start">
                                    <a id="lnkGetAttendance" href="#" class="btn btn-primary" style="font-size: small" onclick="GetAttendanceByDesignationAndDate(event); return false;">Get Attendance
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="dvWorkgroupEmployee" class="table-responsive mt-4">
                            <table id="tblWorkgroupAttendance"></table>
                        </div>
