...
{
    /// <summary>
    /// Summary description for EmployeeProfileGeneratorForWorkGroupByDateRange
    /// </summary>
    public class EmployeeProfileGeneratorForWorkGroupByDateRange : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                System.DateTime lcl_dt_WorkDateFrom = System.DateTime.Parse(context.Request["WorkDateFrom"].ToString());
                System.DateTime lcl_dt_WorkDateUpto = System.DateTime.Parse(context.Request["WorkDateUpto"].ToString());
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        lcl_str_SqlQuery = System.String.Format("SELECT WG_OP_MSTR.WG_OPERATION_MASTER_CODE " +
                                                                                "FROM WORK_GROUP_OPERATION_MASTER WG_OP_MSTR JOIN WORK_GROUP_OPERATION_HISTORY WG_OP_HSTRY " +
                                                                                "ON WG_OP_MSTR.WG_OPERATION_MASTER_CODE = WG_OP_HSTRY.WG_OPERATION_MASTER_CODE " +
                                                                                "WHERE (WG_OP_MSTR.WORK_DATE BETWEEN  TO_DATE('{0}','DD/MM/YYYY') AND TO_DATE('{1}','DD/MM/YYYY')) AND WG_OP_HSTRY.EMPLOYEE_CODE = {2}", lcl_dt_WorkDateFrom.ToString("dd/M/yyyy"), lcl_dt_WorkDateUpto.ToString("dd/M/yyyy"), lcl_ui64_EmployeeCode);
                                        ...
                                        if (lcl_obj_WorkGroupOperationReader.HasRows)
                                        {
                                            ...
                                            lcl_str_Message = System.String.Format("Invalid File Upload : Employee ID '{0}' has already been assigned to another Work Group between '{1}' and '{2}'!!!Upload Denied!!!", lcl_str_EmployeeId, lcl_dt_WorkDateFrom.ToString("dd/M/yyyy"), lcl_dt_WorkDateUpto.ToString("dd/M/yyyy"));
