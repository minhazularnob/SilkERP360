<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThroughputAnalysis.ascx.cs" Inherits="SilkERP360.UI.SCPM.ThroughputAnalysis" %>
<base href="/SilkERP/UI/" />
<script src="SCPM/Scripts/ThroughputAnalysis.js" type="text/javascript"></script>
...
<div id="dvBody" class="ui_control_wrapper1 box" style="Width:96%;height:auto; margin:0 auto;">
            ...
            <tr>
                ...
                <td style="width:10%; text-align:center;">
                     <p class="login button"> 
                        <asp:Button ID="btnGenerate" runat="server" CssClass="button" Text="Get Throughput" ClientIDMode="Static" OnClientClick=" Analyse(); return false;" style="width:100px;" />&nbsp;
                     </p>
                </td>
            </tr>
    ...
    <div id="dvReport" class="control_container1" style="text-align:center; visibility:visible; margin:0 auto;">
        <div id="dvData" style="width:100%; margin:0 auto;">
            <table id='tblAllSectionData' style="width:100%;">
