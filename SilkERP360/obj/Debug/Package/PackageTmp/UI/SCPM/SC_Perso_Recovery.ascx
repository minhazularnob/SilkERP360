<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SC_Perso_Recovery.ascx.cs" Inherits="SilkERP360.UI.SCPM.SC_Perso_Recovery" %>
<script src="../../Globals/Scripts/plug-ins/jquery.scannerdetection.js" type="text/javascript"></script>
<script src="../../Globals/Scripts/SilkERP360/SCPM/sc_perso_recovery.js" type="text/javascript"></script>
<style type="text/css">
        a.boxclose{
            float:right;
            width:26px;
...
<div id="dvBody" class="ui_control_wrapper" style="Width:99%;height:1024px; margin:0 auto;">
    <div id="cmd" style="width:99%;">
       ...
       <h1>S.C Personalization Recovery</h1>
        ...
        <div id="dvListedDepartments" style="width:100%; float:left; position:relative;">  <%--margin:0 auto;--%>
           ...
           <%-- <div style="height:10px;">
            ...
            <table class="ip_cntrl_cntnr1" style="width:70%; table-layout:fixed;margin:0 auto;">
                ...
                <tr>
                    <td align="center" colspan="2" style="width:100%; text-align:left;height:30px;">
                        <div id="dvOperationStatus" style="width:80%; height:70%; margin:0 auto; text-align:center;">
                            <span id="txtOperationStatus" style="margin:0 auto; font-size:12px; font-weight:bold; color:White;">&nbsp;</span>
                        </div>
                    </td>
                </tr>
                <tr>
            ...
            <br />
            <asp:Table ID="tblRecoveredList" runat="server" ClientIDMode="Static" CellPadding="0" CellSpacing="0" style="width:70%;table-layout:fixed; margin:0 auto; font-size:12px; border:1px; border-style:ridge;">
