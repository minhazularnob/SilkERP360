<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeaveApplicationList.ascx.cs" Inherits="SilkERP360.UI.HRIS.LeaveApplicationList" %>
...
<script src="Scripts/LeaveApplicationList.js" type="text/javascript"></script>
<style type="text/css">
    .overlay{
