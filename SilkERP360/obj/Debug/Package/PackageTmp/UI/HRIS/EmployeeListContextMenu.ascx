<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EmployeeListContextMenu.ascx.cs" Inherits="SilkERP360.UI.HRIS.EmployeeListContextMenu" %>

<%--<script src="../../Globals/jQuery/jquery-ui-1.9.1/ui/jquery.ui.position.js" type="text/javascript"></script>--%>
<%--<script src="../../Globals/Scripts/plug-ins/jquery-ui-contextmenu-master/jquery.ui-contextmenu.js" type="text/javascript"></script>--%>
<%--<script src="../../Globals/Scripts/plug-ins/jQuery-contextMenu-master/src/jquery.contextMenu.js" type="text/javascript"></script>--%>
<%--<script src="../../Globals/Scripts/plug-ins/jQuery-contextMenu-master/src/jquery.ui.position.js" type="text/javascript"></script>--%>
<%--<script src="../../Globals/Scripts/plug-ins/jQuery-contextMenu-master/prettify/prettify.js" type="text/javascript"></script>
<script src="../../Globals/Scripts/plug-ins/jQuery-contextMenu-master/screen.js" type="text/javascript"></script>--%>
...
<%--<link href="../../Globals/Scripts/plug-ins/jQuery-contextMenu-master/prettify/prettify.css" rel="stylesheet" type="text/css" />--%>
<link href="../../Globals/Scripts/plug-ins/jQuery-contextMenu-master/src/jquery.contextMenu.css" rel="stylesheet" type="text/css" />
<link href="../../Globals/Scripts/plug-ins/jQuery-contextMenu-master/screen.css" rel="stylesheet" type="text/css" />
<link href="../../Globals/Scripts/plug-ins/jQuery-contextMenu-master/prettify/prettify.sunburst.css" rel="stylesheet" type="text/css" />

<script src="Scripts/EmployeeListContextMenu.js" type="text/javascript"></script>
