...
<div id="dvBody" class="ui_control_wrapper" style='z-index:1000;'>
    ...
    <div id="tabs" style="width:99%; height:500px; position: relative; z-index: 1002;" >
	    <ul>
    ...
    <div id="OfficialTab" style='z-index:1004;' ><!-- OFFICIAL TAB CONFIGURATION  class="center_div" -->
        ...
        <caption style="width:100%; text-align:center">
              ...
              <tr>
                      ...
                      <tr>
                    <td style="width:15%" align="left">                    
                        <asp:Label ID="Label69" runat="server" Text="Employee Name">
                        </asp:Label>
                    </td>
                     <td style="width:35%" align="left">                    
                         <asp:TextBox ID="txt_Off_Name" runat="server" ClientIDMode="Static" CssClass="input-required" PlaceHolder="Emp. Name">
                         </asp:TextBox>
                     </td>
                     <td style="width:15%" align="left">                    
                         <asp:Label ID="Label70" runat="server" Text="Shift Code">
                         </asp:Label>
                     </td>
                     <td style="width:35%" align="left">                    
             ...
             <tr>
                  ...
                  <td style="width:35%" align="left">                    
                        <asp:TextBox ID="txt_Off_ACSCode" runat="server" ClientIDMode="Static" PlaceHolder="ACS Code" CssClass="input-required">
                        </asp:TextBox>
                  </td>
                 <td style="width:15%" align="left">                    
              ...
              <tr>
                <td style="width:15%" align="left">                    
                        <asp:Label ID="Label73" runat="server" Text="Ref. Employee">
                        </asp:Label>
                </td>
                 <td style="width:35%" align="left">                    
                 ...
                 <td style="width:15%" align="left">                    
                        <asp:Label ID="Label74" runat="server" Text="Search Ref. Employee">
                        </asp:Label>
                  </td>
                 <td style="width:35%" align="left">                    
                        <asp:TextBox ID="txt_Off_AutoRefEmployee" runat="server" ClientIDMode="Static" PlaceHolder="Search RefEmployee" >
                        </asp:TextBox>                                        
                  </td>
            </tr>
                ...
                <td style="width:15%" align="left">
                 ...
                 <td style="width:35%" align="left">
                    ...
                    <asp:TextBox ID="txt_Off_AutoSuperVisor" runat="server" ClientIDMode="Static" PlaceHolder="Search Super Visor" >
                    </asp:TextBox>                                        
                       </td>
              </tr>
                ...
                <td style="width:15%" align="left">
                 ...
                 <td style="width:35%" align="left">
                    ...
                    <asp:TextBox ID="txt_Off_JoiningDate" runat="server" ReadOnly="true" ClientIDMode="Static" PlaceHolder="Joining Date" CssClass="input-required">
                    </asp:TextBox>
                       </td>
                 <td style="width:15%" align="left">
                 ...
                 <td style="width:35%" align="left">
                    ...
                    <asp:TextBox ID="txt_Off_ConfirmationDate" runat="server" ReadOnly="true" ClientIDMode="Static" PlaceHolder="Conf. Date"></asp:TextBox>
                       </td>
              </tr>
	...
	<table id="tblPersonal"  style="width:90%; ">
                            <caption style="width:100%; text-align:center">
    ...
    <center>
        <table id="tblEducationExperienceTabContent"  >
            <tr style="width:100%; height:50%; border:0px; border-style:ridge;">
                <td  style="width:100%; height:100%;">
                    <!-- Table for Education Controls-->
                    <table id="tblEducation" runat="server" style="height:auto;">
                        <caption style="width:100%; text-align:center">
                    ...
                    <asp:Label ID="Label101" runat="server" Text="Passing Year"></asp:Label>
                        ...
                        <tr style="width:100%; text-align:center; ">
                                <th scope="col" abbr="Exam" style="text-align:center" class="style1">
                                    <asp:TextBox ID="txt_Edu_ExamName" runat="server" ReadOnly="false" ClientIDMode="Static" PlaceHolder="Exam" CssClass="input input-required input_element_no_style"> </asp:TextBox>
                                </th>
                                <th scope="col" abbr="Uni" style="text-align:center" class="style2">
                                    <asp:TextBox ID="txt_Edu_BoardUniversity" runat="server" ReadOnly="false" ClientIDMode="Static" PlaceHolder="Board/Uni" CssClass="input-required">
                                    </asp:TextBox>
                                </th>
                                <th scope="col" abbr="Business" style="text-align:center;" class="style2">
                                    <asp:TextBox ID="txt_Edu_InstituteName" runat="server" ReadOnly="false" ClientIDMode="Static" PlaceHolder="Inst. Name" CssClass="input-required">
                                    </asp:TextBox>
                                </th>
                                <th scope="col" abbr="Deluxe" style="text-align:center" class="style2">
                                    <asp:TextBox ID="txt_Edu_MajorSubject" runat="server" ReadOnly="false" ClientIDMode="Static" PlaceHolder="Major Sub." CssClass="input-required">
                                    </asp:TextBox>
                                </th>
                                <th scope="col" abbr="Uni" style="text-align:center" class="style3">
                                    <asp:TextBox ID="txt_Edu_DivisionClass" runat="server" ReadOnly="false" ClientIDMode="Static" PlaceHolder="Division/Class" CssClass="input-required">
                                    </asp:TextBox>
                                </th>
                                ...
                                <th scope="col" abbr="Deluxe" style="text-align:center" class="style3">
                                    <asp:TextBox ID="txt_Edu_PassingYear" runat="server" ReadOnly="false" ClientIDMode="Static"  PlaceHolder="Passing Year" CssClass="input-required">
                                    </asp:TextBox>
                                </th>
     ...
     <div id ="Div1" style="height:225px; z-index: 1009;">
    <center>
    <caption style="width:100%; text-align:center">
                            <h2>Experience Details</h2>
                           
                        </caption>
        <table id="tblEducationExperienceTabContent123"  style="width:100%;">
            <tr style="width:100%; height:50%; border:0px; border-style:ridge;">
                <td  style="width:100%; height:100%;">

                    <!-- Table for Experience Controls-->
                    <table id="tblExperience123" style="height:auto;"  >
                        

                        
                            <tr style="width:100%; text-align:center; height:auto;">
                                <th scope="col" abbr="Exam1" style="width:15%; text-align:center">
                    
                    <asp:Label ID="Label102" runat="server" Text="Organization Name"></asp:Label>
                                    </th>
                                <th scope="col" abbr="Uni1" style="width:20%; text-align:center">
                    
                    <asp:Label ID="Label103" runat="server" Text="Address"></asp:Label>
                                    </th>
                                <th scope="col" abbr="Business1" style="width:10%; text-align:center">
                    
                    <asp:Label ID="Label104" runat="server" Text="Responsibility"></asp:Label>
                                    </th>
                                <th scope="col" abbr="Deluxe1" style="width:15%; text-align:center">
                    
                    <asp:Label ID="Label105" runat="server" Text="Nature Of Job"></asp:Label>
                                    </th>
                                <th scope="col" abbr="Uni2" style="width:15%; text-align:center">
                    
                    <asp:Label ID="Label106" runat="server" Text="Contact No"></asp:Label>
                                    </th>
                                <th scope="col" abbr="Business2" style="width:15%; text-align:center">
                    
                    <asp:Label ID="Label107" runat="server" Text="Date From"></asp:Label>
                                   </th>
                                <th scope="col" abbr="Deluxe2" style="width:15%; text-align:center">
                    
                    <asp:Label ID="Label108" runat="server" Text="Date To"></asp:Label>
                                    </th>
                                </tr>
                            <tr style="width:100%; text-align:center; height:auto;">
                                <th scope="col" abbr="Exam1" style="width:17%; text-align:center">
                                ...
                                <th scope="col" abbr="Business1" style="width:20%; text-align:center">
                                    <asp:TextBox ID="txt_Exp_Responsibility" runat="server"  
                                        ReadOnly="false"  ClientIDMode="Static" 
                                        PlaceHolder="Responsibility"></asp:TextBox>
                                </th>
                                <th scope="col" abbr="Deluxe1" style="width:20%; text-align:center">
            ...
            <tr style="width:100%; height:50%;">
                <td  style="width:100%; height:100%;">
                    <table id="tblExperience" runat="server"></table>
                </td>
            </tr>
        </table>
    </center>
    ...
    <div id="SL" style="height:150px; z-index: 1011;">
        <table id="tblSalaryMain"  style="width:100%;">
        <caption style="width:100%; text-align:center">
            ...
            <tr>
                ...
                <td>
                      <asp:TextBox ID="txt_Stan_Sal_Others" class="currency_field" runat="server" style="text-align:right;" ReadOnly="false" ClientIDMode="Static"> </asp:TextBox>
                 </td>
                <td>
                      <asp:TextBox ID="txt_Stan_Sal_Gross" runat="server" style="text-align:right;" class="currency_field" ReadOnly="false" ClientIDMode="Static"> </asp:TextBox>
                 </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                                            <asp:TextBox ID="txt_Sal_Entertainment" style="text-align:right;" ReadOnly="true" runat="server" class="salary_field currency_field" onkeypress='return IsDouble(event)' ClientIDMode="Static" Text="0.00"> </asp:TextBox>
                                        </td>
                <td>
                                            <asp:TextBox ID="txt_Sal_Conveyence" runat="server" style="text-align:right;" class="input-required salary_field currency_field" onkeypress='return IsDouble(event)' ReadOnly="true" ClientIDMode="Static" Text="0.00"> </asp:TextBox>
                                        </td>
                <td>
                                            <asp:TextBox ID="txt_Sal_PhoneBill" runat="server" style="text-align:right;" class="salary_field currency_field" onkeypress='return IsDouble(event)' ReadOnly="true" ClientIDMode="Static" Text="0.00"> </asp:TextBox>
                                        </td>
                <td>
                                            <asp:TextBox ID="txt_Sal_Others" runat="server" style="text-align:right;" ReadOnly="true" class="salary_field currency_field" onkeypress='return IsDouble(event)' ClientIDMode="Static" Text="0.00"> </asp:TextBox>
                                        </td>
                <td>
    ...
    <caption style="width:100%; text-align:center">
                        ...
                        <table id="tblLeave"  runat="server" style="width:80%" bgcolor="#CCCCCC" border="1">
    ...
    <div id="ReferenceTab" style='z-index:1012;'>
      <table id="tblReference"  style="width:100%;">
            ...
            <tr>
                ...
                <td>                   
                                                <asp:TextBox ID="txt_Ref_Name1" runat="server" ClientIDMode="Static" PlaceHolder="Name">
                                                </asp:TextBox>
                </td>
                <td>
                                               <asp:TextBox ID="txt_Ref_Address1" runat="server"  ClientIDMode="Static" PlaceHolder="Address">
                                                </asp:TextBox>
                </td>
                <td>                  
                                                <asp:TextBox ID="txt_Ref_ContactNo1" runat="server"  ClientIDMode="Static" PlaceHolder="Phone / Mobile">
                                                </asp:TextBox>
                </td>
                <td>
                                                <asp:TextBox ID="txt_Ref_Organization1" runat="server"  ClientIDMode="Static" PlaceHolder="Organization">
                                                </asp:TextBox>
                </td>
                <td>
                                                <asp:TextBox ID="txt_Ref_Designation1" runat="server" ClientIDMode="Static" PlaceHolder="Designation">
                                                </asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                                                <asp:TextBox ID="txt_Ref_Address2" runat="server"  ClientIDMode="Static" PlaceHolder="Address">
                                                </asp:TextBox>
                                            </td>
                <td>                   
                                                <asp:TextBox ID="txt_Ref_ContactNo2" runat="server" ClientIDMode="Static" PlaceHolder="Phone / Mobile">
                                                </asp:TextBox>
                </td>
                <td>
                                                <asp:TextBox ID="txt_Ref_Organization2" runat="server"  ClientIDMode="Static" PlaceHolder="Organization" ontextchanged="txt_Ref_Organization2_TextChanged">
                                                </asp:TextBox>
                                            </td>
                <td>
                                                <asp:TextBox ID="txt_Ref_Designation2" runat="server" ClientIDMode="Static" PlaceHolder="Designation">
                                                </asp:TextBox>
                                            </td>
            </tr>
