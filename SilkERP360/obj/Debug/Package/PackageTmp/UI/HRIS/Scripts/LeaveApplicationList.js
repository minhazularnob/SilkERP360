...
$(document).ready(function () {
    ...
    $(document).contextmenu({
        ...
        menu: [
			...
			{ title: "Leave Approve ", cmd: "LeaveApprove", uiIcon: "", action: function (event, ui) {
			    debugger;
			    var lcl_ui64_EmployeeCode = ui.target.attr('id');
			   // var lcl_ui64_LeaveCode = 
			    $('#hdrSubForm').text('Leave Approve');
			    ...
			    $.ajax(
                {
                   ...
                   // url: "~/../../../WebServices/UILoaderService.asmx/GetUIByEmployee",
                    ...
                    data: "{IP_ui64_EmployeeCode: " + lcl_ui64_EmployeeCode + ",IP_str_VirtualPath:" + JSON.stringify('~/UI/HRIS/NewLeaveApproved.ascx') + "}", //provide input for the getSM_PO method
                    dataType: "json",
