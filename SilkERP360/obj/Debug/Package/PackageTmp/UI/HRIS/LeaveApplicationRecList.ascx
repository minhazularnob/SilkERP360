<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeaveApplicationRecList.ascx.cs" Inherits="SilkERP360.UI.HRIS.LeaveApplicationRecList" %>
...
<script src="Scripts/LeaveRecList.js" type="text/javascript"></script>
<style type="text/css">
    .overlay{
