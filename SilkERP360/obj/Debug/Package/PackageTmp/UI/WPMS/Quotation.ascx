<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Quotation.ascx.cs" Inherits="SilkERP360.UI.WPMS.Quotation" %>


<link href="CSS/Quotation.css" rel="stylesheet" type="text/css" />
                        ...
                        <div id="tbpPriceQuotation" style=" width:100%; margin:0 auto;">
                            ...
                            <table style="width:100%; margin:0 auto;">
                                <tr>
                                    ...
                                    <div>
                                                        ...
                                                        <a class='command_button_enabled' id='A11'
                                                            onclick="SaveQuotaion(); return false;" href='#'>Save</a></div>
                                        ...
                                        <tr><td colspan="2">
                                           ...
                                           <td>
                                               <asp:TextBox ID="txtCustomeReq" runat="server" TextMode="MultiLine"></asp:TextBox>
                                           </td>
                                           </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td id="RawMaterialPrice" colspan="3"style="text-align:center;width:100%;">
                                                                        ...
                                                                        <asp:TextBox ID="TextBox42" runat="server" Width="90%"  
                                                                            ...
                                                                            Enabled="False"></asp:TextBox>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="style55" style="padding:1px; text-align:left;">
                                                                                    ...
                                                                                    <td style="padding:1px; text-align:center;" class="style56">
