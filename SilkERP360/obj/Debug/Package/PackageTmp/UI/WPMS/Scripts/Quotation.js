...
//                                 { name: 'Image', display: 'img', type: 'image'},
                                 ...
                                 { name: 'ItemCode', type: 'hidden', value: 0 },
                                 { name: 'CatagoryCode', type: 'hidden', value: 0 },
...
function Newcustomer() {
    ...
    function SaveQuotaion()
    {
                    ...
                    lcl_obj_Quotaion.BuyerCode= $("#ddlBuyer option:selected").val();
                    lcl_obj_Quotaion.CustomerReq= $("#txtCustomeReq").val();
                    //lcl_obj_Quotaion.QuotationDate=$("#lblTodayDate").val();
                    lcl_obj_Quotaion.IPEmployeeCode     =   $("#txtSignedInEmployeeCode").val();
       ...
       debugger;
                    ...
                    lcl_obj_Quotaion.QuotationDetails[j].ItemCode         =   $('#tblProductDetails').appendGrid('getCtrlValue', 'ItemCode', j);
                    lcl_obj_Quotaion.QuotationDetails[j].ProductDesc         =   $('#tblProductDetails').appendGrid('getCtrlValue', 'Desc', j);
                    lcl_obj_Quotaion.QuotationDetails[j].ItemCatagoryCode    =   $('#tblProductDetails').appendGrid('getCtrlValue', 'CatagoryCode', j);
                    ...
                    lcl_obj_Quotaion.QuotationDetails[j].NetWeight              =   $('#tblProductDetails').appendGrid('getCtrlValue', 'Wgt1tp', j);
                    lcl_obj_Quotaion.QuotationDetails[j].PkgCarton              =   $('#tblProductDetails').appendGrid('getCtrlValue', 'Carton', j);
                    lcl_obj_Quotaion.QuotationDetails[j].PkgPcsPerCarton        =   $('#tblProductDetails').appendGrid('getCtrlValue', 'PcsPerCarton', j);
                    lcl_obj_Quotaion.QuotationDetails[j].QtyKg              =   $('#tblProductDetails').appendGrid('getCtrlValue', 'KG', j);
                    lcl_obj_Quotaion.QuotationDetails[j].UnitPriceCifFos     =   $('#tblProductDetails').appendGrid('getCtrlValue', 'UnitPrice', j);
                    lcl_obj_Quotaion.QuotationDetails[j].TotalAmountCofFos   =   $('#tblProductDetails').appendGrid('getCtrlValue', 'TotalPrice', j);
...
//                        async: false,
//                        contentType: "application/json; charset=utf-8",
//                        url: gbl_URL_Root + "WebServices/WPMS/Buyer.asmx/LoadCustomerCode", 
