...
namespace MailService
{
    public class Mailer
    {
        ...
        {
            this.m_obj_SmtpClient = new SmtpClient(MailService.MailSettings.SMTP_SERVER_IP, MailService.MailSettings.PORT);
            this.m_obj_SmtpClient.Timeout = 600000;
            this.m_obj_SmtpClient.EnableSsl = true;
            this.m_obj_SmtpClient.DeliveryMethod = SmtpDeliveryMethod.Network;
            this.m_obj_SmtpClient.UseDefaultCredentials = false;
            this.m_obj_SmtpClient.Credentials = new NetworkCredential(MailService.MailSettings.MAIL_ID, MailService.MailSettings.MAIL_PASSWORD);

            this.m_obj_FromMailAddress = new MailAddress(MailService.MailSettings.MAIL_ID, MailService.MailSettings.MAIL_SENDER_DISPLAY_NAME);
        ...
        protected void SendMail(System.String IP_str_Subject, System.String IP_str_MailBodyHTML)
        {
            try
            {
