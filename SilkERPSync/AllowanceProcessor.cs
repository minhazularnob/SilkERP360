...
{
    /// <summary>
    /// Processes Various Monthly Allowance for Salary Generation
    /// </summary>
    public class AllowanceProcessor : System.IDisposable
    {
        private System.Double NIGHT_ALLOWANCE = 30.0;
        ...
        public AllowanceProcessor(SilkERP360.CCL.Enums.Month IP_enm_Month, System.UInt16 IP_ui16_Year)
        {
        ...
        public void Init(System.String IP_str_DatabaseConnectionString)
        {
            ...
            {
                SilkERP360.SP.HRIS.ServiceLog.LogData("Allowance Processor Error : " + Ex.Message);
            }
        }
        ...
        public void ProcessMonthlyAllowance(System.UInt64 IP_ui64_CompanyCode)
        {
        ...
        /// <summary>
        /// The Company Pays a fixed allowance for the employees who do night duty.
        /// Function checks Attendance Entity to figure out which employees did
        /// duty in the night
        /// 1. Get List Of All Employees
        /// 2. 
        /// </summary>
        /// <param name="IP_ui64_CompanyCode"></param>
        public void ProcessNightAllowance(System.UInt64 IP_ui64_CompanyCode)
        {
            try
            {
            }
