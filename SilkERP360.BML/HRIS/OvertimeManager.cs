        ...
        public CCL.BusinessEntities.HRIS.Overtime Get(ulong IP_ui64_Code)
        {
            ...
            lcl_obj_Overtime = this.ExceptionManager.Process<CCL.BusinessEntities.HRIS.Overtime>(() =>
            {
                using (var lcl_obj_DBManager = SilkERP360.DAL.DALObjectPoolManager.DBManagerPool.GetObject())
                {
                    ...
                    Oracle.ManagedDataAccess.Client.OracleDataReader lcl_obj_dr = lcl_obj_DBManager.InternalResource.ExecuteDataReader(System.String.Format(@"Select * From SCPM_SM_PEEL_OFF_QC SM_PEEL_OFF_CODE= {0} and STATUS = 1", IP_ui64_Code, (System.UInt32)SilkERP360.CCL.Enums.Status.Active));
