...
namespace SilkERP360.BML.HRIS
{
        ...
        SilkERP360.CCL.Interfaces.IManagerOperations<SilkERP360.CCL.BusinessEntities.HRIS.EmployeeEducation>
    {
        ...
        public ulong Save(SilkERP360.CCL.BusinessEntities.HRIS.EmployeeEducation lcl_obj_EmployeeEducation, object IP_obj_DBManager)
        {
            ulong lcl_ui64_EducationCode = 0;

            lcl_ui64_EducationCode = this.ExceptionManager.Process<ulong>(() =>
            {
                SilkERP360.DAL.DBManager lcl_obj_DBManager = (SilkERP360.DAL.DBManager)IP_obj_DBManager;
                ...
                // 1. Get next sequence value if EducationCode is 0
                if (lcl_obj_EmployeeEducation.EducationCode == 0)
                {
                    using (var seqCmd = new OracleCommand("select max(EDUCATION_CODE)+1 from EMPLOYEE_EDUCATION", lcl_obj_DBManager.Connection))
                    {
                        seqCmd.Transaction = lcl_obj_DBManager.Transaction;
                        lcl_ui64_EducationCode = Convert.ToUInt64(seqCmd.ExecuteScalar());
                    }
                }
                else
                {
                    lcl_ui64_EducationCode = lcl_obj_EmployeeEducation.EducationCode;
                }
                ...
                using (var cmd = new OracleCommand(sql, lcl_obj_DBManager.Connection))
                {
                    ...
                    cmd.Parameters.Add(":EDUCATION_CODE", OracleDbType.Int64).Value = lcl_ui64_EducationCode;
                    cmd.Parameters.Add(":EXAM_NAME", OracleDbType.NVarchar2).Value = lcl_obj_EmployeeEducation.ExamName;
                    cmd.Parameters.Add(":INST_NAME", OracleDbType.NVarchar2).Value = lcl_obj_EmployeeEducation.InstName;
                    cmd.Parameters.Add(":BOARD_UNIVERSITY", OracleDbType.NVarchar2).Value = lcl_obj_EmployeeEducation.BoardUniversity;
                    cmd.Parameters.Add(":MAJOR_SUBJECT", OracleDbType.NVarchar2).Value = lcl_obj_EmployeeEducation.MajorSubject;
                    cmd.Parameters.Add(":DIVISION_CLASS", OracleDbType.NVarchar2).Value = lcl_obj_EmployeeEducation.DivisionClass;
                    cmd.Parameters.Add(":CGPA", OracleDbType.NVarchar2).Value = lcl_obj_EmployeeEducation.Cgpa;
                    cmd.Parameters.Add(":PASS_YEAR", OracleDbType.Int64).Value = lcl_obj_EmployeeEducation.PassYear;
                    cmd.Parameters.Add(":EMPLOYEE_CODE", OracleDbType.Int64).Value = lcl_obj_EmployeeEducation.EmployeeCode;
                    cmd.Parameters.Add(":IS_DELETED", OracleDbType.Int64).Value = 1;
                    cmd.Parameters.Add(":STATUS", OracleDbType.Int64).Value = 1;
        ...
        public ulong Save(SilkERP360.CCL.BusinessEntities.HRIS.EmployeeEducation lcl_obj_EmployeeEducation)
        {
            ...
            lcl_ui64_EducationCode = this.ExceptionManager.Process<System.UInt64>(() =>
            {
                using (var lcl_obj_DBManager = SilkERP360.DAL.DALObjectPoolManager.DBManagerPool.GetObject())
                {
                    ...
                    OracleParameter lcl_obj_EducationCode = new OracleParameter("v_EDUCATION_CODE", OracleDbType.Int64);
                    lcl_obj_EducationCode.Direction = System.Data.ParameterDirection.Output;
                    lcl_obj_EducationCode.Value = lcl_obj_EmployeeEducation.EducationCode;

                    OracleParameter lcl_obj_ExamName = new OracleParameter("v_EXAM_NAME", OracleDbType.Int64);
                    ...
                    OracleParameter lcl_obj_InstName = new OracleParameter("v_INST_NAME", OracleDbType.Int64);
                    ...
                    OracleParameter lcl_obj_BoardUniversity = new OracleParameter("v_BOARD_UNIVERSITY", OracleDbType.Int64);
                    ...
                    OracleParameter lcl_obj_MajorSubject = new OracleParameter("v_MAJOR_SUBJECT", OracleDbType.Int64);
                    ...
                    OracleParameter lcl_obj_DivisionClass = new OracleParameter("v_DIVISION_CLASS", OracleDbType.Int64);
                    ...
                    OracleParameter lcl_obj_Cgpa = new OracleParameter("v_Cgpa", OracleDbType.Int64);
                    lcl_obj_Cgpa.Direction = System.Data.ParameterDirection.Output;
                    lcl_obj_Cgpa.Value = lcl_obj_EmployeeEducation.EducationCode;

                    OracleParameter lcl_obj_PassYear = new OracleParameter("v_PASS_YEAR", OracleDbType.Int64);
                    ...
                    OracleParameter[] lcl_obj_SP_Parameters = { lcl_obj_EducationCode, lcl_obj_ExamName, lcl_obj_InstName, lcl_obj_BoardUniversity, lcl_obj_MajorSubject, lcl_obj_DivisionClass, lcl_obj_Cgpa, lcl_obj_PassYear, lcl_obj_EmployeeCode };
        ...
        public CCL.BusinessEntities.HRIS.EmployeeEducation Get(ulong IP_ui64_Code, System.Object IP_obj_DBManager)
        {
            ...
            lcl_obj_EmployeeEducation = this.ExceptionManager.Process<SilkERP360.CCL.BusinessEntities.HRIS.EmployeeEducation>(() =>
            {
                ...
                Oracle.ManagedDataAccess.Client.OracleDataReader lcl_obj_EmpEducationReader = lcl_obj_DBManager.ExecuteDataReader(lcl_str_SqlQuery);
           ...
           lcl_obj_EmployeeEducation = this.ExceptionManager.Process<SilkERP360.CCL.BusinessEntities.HRIS.EmployeeEducation>(() =>
            {
                using (var lcl_obj_DBManager = SilkERP360.DAL.DALObjectPoolManager.DBManagerPool.GetObject())
                {
                    ...
                    Oracle.ManagedDataAccess.Client.OracleDataReader dr = lcl_obj_DBManager.InternalResource.ExecuteDataReader(System.String.Format("Select * From EMPLOYEE_EDUCATION Where EDUCATION_CODE = {0} and STATUS = {1} IS_DELETED = 1", IP_ui64_Code, SilkERP360.CCL.Enums.Status.Active));
                    if (!(dr.HasRows))
                    {
