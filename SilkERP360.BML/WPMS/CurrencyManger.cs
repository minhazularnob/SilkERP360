...
{
   public class CurrencyManger : SilkERP360.CCL.ExceptionManagement.Base.ExceptionManagementBase,
         SilkERP360.CCL.Interfaces.IManagerOperations<SilkERP360.CCL.BusinessEntities.WPMS.Currency>
    {
        public ulong Save(CCL.BusinessEntities.WPMS.Currency IP_obj_A, object IP_obj_DBManager)
        {
            ...
            lcl_ui64_BuyerCode = this.ExceptionManager.Process<System.UInt64>(() =>
            {
                ...
                IP_obj_A.CurrencyCode = lcl_ui64_ID;
        ...
        public ulong Save(CCL.BusinessEntities.WPMS.Currency IP_obj_A)
        {
            throw new NotImplementedException();
        }

        public CCL.BusinessEntities.WPMS.Currency Get(ulong IP_ui64_Code, object IP_obj_DBManager)
        {
            throw new NotImplementedException();
        }
        ...
        public CCL.BusinessEntities.WPMS.Currency Get(string IP_str_SqlQuery, object IP_obj_DBManager)
        {
            throw new NotImplementedException();
        }
        ...
        public List<CCL.BusinessEntities.WPMS.Currency> GetList(string IP_str_SqlQuery, object IP_obj_DBManager)
        {
            throw new NotImplementedException();
        }
