        ...
        public ulong Save(CCL.BusinessEntities.SCPM.ScpmSmMasterBatch IP_obj_A)
        {
            ...
            lcl_ui64_MasterBatchCode = this.ExceptionManager.Process<System.UInt64>(() =>
            {
                ...
                using(var lcl_obj_DBManager = SilkERP360.DAL.DALObjectPoolManager.DBManagerPool.GetObject())
                {
                    ...
                    Oracle.ManagedDataAccess.Client.OracleDataReader lcl_obj_MasterBatchReader = lcl_obj_DBManager.InternalResource.ExecuteDataReader(lcl_str_SqlQuery);
                    /************************************************************************************************************************/
        ...
        public CCL.BusinessEntities.SCPM.ScpmSmMasterBatch Get(ulong IP_ui64_Code)
        {
            ...
            lcl_obj_ScpmSmMasterBatch = this.ExceptionManager.Process<SilkERP360.CCL.BusinessEntities.SCPM.ScpmSmMasterBatch>(() =>
            {
                using (var lcl_obj_DBManager = SilkERP360.DAL.DALObjectPoolManager.DBManagerPool.GetObject())
                {
                    ...
                    Oracle.ManagedDataAccess.Client.OracleDataReader lcl_obj_dr = lcl_obj_DBManager.InternalResource.ExecuteDataReader(System.String.Format(@"Select * From SCPM_MASTER_BATCH MASTER_BATCH_CODE= {0} and STATUS = 1", IP_ui64_Code, (System.UInt32)SilkERP360.CCL.Enums.Status.Active));
