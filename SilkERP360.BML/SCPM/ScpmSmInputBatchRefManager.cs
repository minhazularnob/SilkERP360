       ...
       public CCL.BusinessEntities.SCPM.ScpmSmInputBatchRef Get(ulong IP_ui64_Code)
       {
           ...
           lcl_obj_ScpmSmInputBatchRef = this.ExceptionManager.Process<SilkERP360.CCL.BusinessEntities.SCPM.ScpmSmInputBatchRef>(() =>
           {
               using (var lcl_obj_DBManager = SilkERP360.DAL.DALObjectPoolManager.DBManagerPool.GetObject())
               {
                   ...
                   Oracle.ManagedDataAccess.Client.OracleDataReader lcl_obj_dr = lcl_obj_DBManager.InternalResource.ExecuteDataReader(System.String.Format(@"Select * From From SCPM_INPUT_BATCH_REF IBF_CODE= {0}", IP_ui64_Code, (System.UInt32)SilkERP360.CCL.Enums.Status.Active));
