       ...
       public CCL.BusinessEntities.SCPM.ScpmSmPersoTrace Get(ulong IP_ui64_Code)
       {
           ...
           lcl_obj_ScpmSmPersoTrace = this.ExceptionManager.Process<SilkERP360.CCL.BusinessEntities.SCPM.ScpmSmPersoTrace>(() =>
           {
               using (var lcl_obj_DBManager = SilkERP360.DAL.DALObjectPoolManager.DBManagerPool.GetObject())
               {
                   ...
                   Oracle.ManagedDataAccess.Client.OracleDataReader lcl_obj_dr = lcl_obj_DBManager.InternalResource.ExecuteDataReader(System.String.Format(@"Select * From SCPM_SM_PERSO_TRACE SM_PERSO_TRACE_CODE= {0} and STATUS = 1", IP_ui64_Code, (System.UInt32)SilkERP360.CCL.Enums.Status.Active));
