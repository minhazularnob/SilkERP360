       ...
       public CCL.BusinessEntities.SCPM.ScpmSmQCMaster Get(ulong IP_ui64_Code)
       {
           ...
           lcl_obj_ScpmSmQCMaster = this.ExceptionManager.Process<SilkERP360.CCL.BusinessEntities.SCPM.ScpmSmQCMaster>(() =>
           {
               using (var lcl_obj_DBManager = SilkERP360.DAL.DALObjectPoolManager.DBManagerPool.GetObject())
               {
                   ...
                   System.Data.OracleClient.OracleDataReader lcl_obj_dr = lcl_obj_DBManager.InternalResource.ExecuteDataReader(System.String.Format(@"Select * From SCPM_SM_QC_MASTER SM_QC_MASTER_CODE= {0} and STATUS = 1", IP_ui64_Code, (System.UInt32)SilkERP360.CCL.Enums.Status.Active));
