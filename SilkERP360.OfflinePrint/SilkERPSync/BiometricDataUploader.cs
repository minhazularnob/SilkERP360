...
namespace SilkERPSync
{
    ...
    public class BiometricDataUploader
    {
        ...
        private System.String BIOMETRIC_DATA_SERVER_CONNECTION_STRING = @"Data Source=192.168.48.10;Initial Catalog=CCFTCentral;Uid=system;Password=system";
        ...
        public void ReadAndUpload()
        {
         ...
         --BETWEEN cast(convert(varchar,getdate(),101) as datetime)+'01/01/1900 00:00:01' AND cast(convert(varchar,getdate(),101) as datetime)+'01/01/1900 23:59:01'
            ...
            ORDER BY Timelog_ID";
                ...
                lcl_sb_LogBuilder.AppendLine("Number Of BMS_TRANSACTION Uploaded : " + lcl_objLst_SilkERPInsert.Count);
